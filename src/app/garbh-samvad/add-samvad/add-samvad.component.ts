...
@Component({
  selector: 'app-add-samvad',
  templateUrl: './add-samvad.component.html',
  styleUrls: ['./add-samvad.component.css']
})
export class AddSamvadComponent implements OnInit {
  ...
  constructor(private fb: FormBuilder,
    ...
    private dialogRef: MatDialogRef<AddSamvadComponent>,
  ...
  onSubmit(){
    ...
    if(pregDayBoolean){
      ...
      console.log(data)
      this.firebaseService.createDoc("garbhSamvad",data).then(()=>{
  ...
  onUpdate(){
    ...
    if(pregDayBoolean){
      ...
      this.formData = {
        ...
        this.firebaseService.updateDoc("garbhSamvad",this.musicData.id,this.formData).then(()=>{
