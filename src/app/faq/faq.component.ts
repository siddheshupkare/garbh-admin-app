  ...
  ngOnInit(): void {
    ...
    firebase.firestore().collection("FAQ").get().then((querySnapshot) => {
      querySnapshot.forEach((doc) => {
          ...
          var a = doc.data().answer
          console.log(typeof(a))

 if(a.trim() === "Not answered")
{
    // your code

    console.log("hello")
    this.status_card="Publish"
}

else
{
  console.log("hi")
  this.status_card="Update"
}


          arr.push({"name":doc.data().name,"question":doc.data().question,"answer":doc.data().answer,"id":doc.id,"Status":this.status_card})
...
firebase.firestore().collection("FAQ").doc(id).delete().then(() => {
  this.ngOnInit()
